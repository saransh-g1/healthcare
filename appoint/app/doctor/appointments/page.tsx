...
export default function Sessions(){
    ...
    return(
      ...
      <div className="h-80 mx-3 my-3 border border-slate-500 rounded-lg text-lg font-semibold text-slate-700">
        ...
        <button className="bg-green-300 text-green-700 rounded-lg h-10 w-96 my-4 text-center">Accept Booking</button>
        <button className="bg-red-400 ml-3  text-white rounded-lg h-10 w-96 my-4 text-center">Reject</button>
        </div>
        </div>
      </div>
            </div>
