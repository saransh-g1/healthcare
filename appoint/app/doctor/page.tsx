...
return(
    <div className=" w-max overflow-hidden m-3" style={{width:"1037px"}} >
    <div className="flex justify-between items-center " style={{width:"1030px"}}>
    ...
    <div className="" style={{width:"1038px", marginTop:"-260px"}}>
