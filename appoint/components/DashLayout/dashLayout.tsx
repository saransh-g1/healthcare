    ...
    return(
        <div className="w-72 h-screen  border-r">
            <div className="flex flex-col items-center justify-center mt-12 border-b-2 ">
                ...
                <div>
                    <p className="text-2xl font-semibold">Saransh keshari</p>
                    <p className="text-sm ">abc@gmail.com</p>
                </div>
                </div>
                <button className="bg-blue-200 text-blue-700 font-semibold h-8 w-60 rounded-sm my-10"> Log Out</button>
            </div>
        <div className="flex flex-col justify-center items-center">
                ...
                <p className="font-bold ml-2">My appointments</p>
                 ...
                 <button className="my-2 focus:border-r-4 focus:border-blue-700 flex justify-center items-center w-72 h-8 focus:text-blue-400 " onClick={()=>{router.push("/dashboard/settings")}}>
                 <div className="flex justify-start items-center w-40">
